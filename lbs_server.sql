...
-- Dumping data for table lbs_server.lbs_admin: ~1 rows (approximately)
...
-- Dumping data for table lbs_server.lbs_driver: ~1 rows (approximately)
...
-- Dumping data for table lbs_server.lbs_order: ~1 rows (approximately)
/*!40000 ALTER TABLE `lbs_order` DISABLE KEYS */;
INSERT INTO `lbs_order` (`order_id`, `park_name`, `park_address`, `driver_number`, `order_date`, `order_info`, `order_price`, `order_status`, `admin_id`, `driver_id`) VALUES
	(1, '苏州独墅湖高等教育区', '江苏省苏州市吴中区苏州独墅湖高等教育区', 5, '2015-03-05', '提前10分钟预定收取：5元', '25', 0, 1, 1);
